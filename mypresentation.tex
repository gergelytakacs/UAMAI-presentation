...
%\bibliographyfile{Bibliography.bib}{EN}             % Use only with "biber"  for BiBLaTeX / Iba používať pre "biber" pre BiBLaTeX
...
%\referencesslidebiber{EN}                  % Use only with "biber"  for BiBLaTeX / Iba používať pre "biber" pre BiBLaTeX
\end{document}
