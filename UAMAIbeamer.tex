...
%            \node[anchor=south west,yshift=-0.4mm,xshift=0mm] at (current page.south west) {\includegraphics[height=2mm]{footer_EN_STU}};
%      \end{tikzpicture}}
%          {SjF}{
%      \begin{tikzpicture}[remember picture,overlay]
%            \node[anchor=south west,yshift=-0.4mm,xshift=0mm] at (current page.south west) {\includegraphics[height=2mm]{footer_EN_SjF}};
%      \end{tikzpicture}}
%      }
%    }
%    {SK}{
...
%        {STU}{
%      \begin{tikzpicture}[remember picture,overlay]
%            \node[anchor=south west,yshift=-0.4mm,xshift=0mm] at (current page.south west) {\includegraphics[height=2mm]{footer_SK_STU}};
%      \end{tikzpicture}}
%          {SjF}{
%      \begin{tikzpicture}[remember picture,overlay]
%            \node[anchor=south west,yshift=-0.4mm,xshift=0mm] at (current page.south west) {\includegraphics[height=2mm]{footer_SK_SjF}};
%      \end{tikzpicture}}
%      }
%    }
%  }
